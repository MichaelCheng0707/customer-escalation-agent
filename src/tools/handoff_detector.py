...
def detect_handoff_signal(bot_message: str) -> bool:
    ...
    strict_signal_patterns = [
        ...
        "i'm transferring you to a live billing representative",
        "i am transferring you to a live billing representative",
        "i'm transferring you to a live support representative",
        "i am transferring you to a live support representative",
